<?php
// HTTP
define('HTTP_SERVER', 'http://' . $_SERVER['SERVER_NAME'].'/store/upload/admin/');
define('HTTP_CATALOG', 'http://' . $_SERVER['SERVER_NAME'].'/store/upload/');

// HTTPS
define('HTTPS_SERVER', 'http://' . $_SERVER['SERVER_NAME'].'/store/upload/admin/');
define('HTTPS_CATALOG', 'http://' . $_SERVER['SERVER_NAME'].'/store/upload/');

// DIR
define('DIR_APPLICATION', $_SERVER['DOCUMENT_ROOT'].'/store/upload/admin/');
define('DIR_SYSTEM', $_SERVER['DOCUMENT_ROOT'].'/store/upload/system/');
define('DIR_IMAGE', $_SERVER['DOCUMENT_ROOT'].'/store/upload/image/');
define('DIR_LANGUAGE', $_SERVER['DOCUMENT_ROOT'].'/store/upload/admin/language/');
define('DIR_TEMPLATE', $_SERVER['DOCUMENT_ROOT'].'/store/upload/admin/view/template/');
...
define('DIR_CATALOG', $_SERVER['DOCUMENT_ROOT'].'/store/upload/catalog/');
